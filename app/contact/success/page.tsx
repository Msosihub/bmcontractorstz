 ...
 * --------------------
 * Confirms that BM Contractors has received a contact message.
 *
 * Purpose:
 * - Gives customer confidence that the message was received.
 * - Provides WhatsApp option for urgent follow-up.
...
export default async function ContactSuccessPage({ searchParams }: PageProps) {
  ...
  const content = {
    en: {
      ...
      message:
        "Thank you. BM Contractors has received your message. Our team will contact you soon.",
    ...
    sw: {
      ...
      message:
        "Asante. BM Contractors tumepokea ujumbe wako. Timu yetu itakutafuta hivi karibuni.",
