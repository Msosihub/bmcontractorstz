/**
 * Support Articles Seed Data
 * --------------------------
 * Sample customer help center articles for BM Contractors.
 *
 * Purpose:
 * - Quickly fills Neon database with useful support articles.
 * - Avoids manual support article entry during early development.
 * - Gives /support and /support/[slug] real database content.
 *
 * Later:
 * - Add article images.
 * - Add categories/tags.
 * - Add published/unpublished editing from admin.
 */

export const supportArticleSeeds = [
  {
  ...
  {
    slug: "cctv-remote-viewing",
    categoryEn: "CCTV",
    categorySw: "CCTV",
    titleEn: "Can I view CCTV cameras on my phone?",
    titleSw: "Naweza kuona camera za CCTV kwenye simu?",
    summaryEn:
      "Learn what is needed to view your CCTV system remotely on a phone.",
    summarySw:
      "Fahamu kinachohitajika ili kuona CCTV yako kwenye simu ukiwa mbali.",
    contentEn:
      "Yes, many CCTV systems can be viewed on a phone if the DVR/NVR supports remote viewing and the site has reliable internet. BM Contractors can help configure the mobile app, network settings and basic user guidance.",
    contentSw:
      "Ndiyo, mifumo mingi ya CCTV inaweza kuonekana kwenye simu kama DVR/NVR ina-support remote viewing na site ina internet ya kuaminika. BM Contractors tunaweza kusaidia kuset app, network settings na maelekezo ya matumizi.",
  },
  {
    slug: "cctv-storage-days",
    categoryEn: "CCTV",
    categorySw: "CCTV",
    titleEn: "How many days can CCTV record?",
    titleSw: "CCTV inaweza kurekodi siku ngapi?",
    summaryEn:
      "Understand what affects CCTV recording duration and storage planning.",
    summarySw:
      "Fahamu vitu vinavyoathiri muda wa CCTV kurekodi na kupanga storage.",
    contentEn:
      "CCTV recording days depend on HDD size, number of cameras, camera resolution, frame rate, recording mode and compression. A site survey helps estimate the correct HDD size for your needs.",
    contentSw:
      "Siku za kurekodi CCTV hutegemea ukubwa wa HDD, idadi ya cameras, resolution ya camera, frame rate, recording mode na compression. Ukaguzi wa site husaidia kukadiria HDD sahihi kwa mahitaji yako.",
  },
  {
