 ...
 * Services Seed Data
 * ------------------
 * Sample service records for BM Contractors.
 *
 * Purpose:
 * - Fills Neon database with main service pages.
 * - Lets /services and /services/[slug] read real database content.
 * - Avoids manual service content entry during development.
 *
 * Later:
 * - Add real service images.
 * - Add richer content blocks.
 * - Add admin image upload.
 */
